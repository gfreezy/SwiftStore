...
public struct EntityMacro: MemberMacro, ExtensionMacro {
    public static func expansion(
        ...
        // Note: Memberwise init is auto-generated by Swift since Decodable init is in extension
        // Decodable init is generated in ExtensionMacro using EmbeddedMacro.generateDecodableExtension
    ...
    public static func expansion(
        ...
        // Get properties and add default values (same logic as MemberMacro)
        var properties = structDecl.extractProperties()
        let syncKeyInfo = SyncKeyMarkerParser.parse(from: structDecl.memberBlock.members)
        let hasSyncKey = syncKeyInfo != nil
